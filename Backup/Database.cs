		...
		public static OleDbConnection Connection
		{
			get
			{
				if (connection == null)
				{
                    ...
                    //databaseServerName = "sql324.mysite4now.com";
                    databaseServerName = "aster.arvixe.com";
                    ...
                    connect = String.Format("Provider=SQLNCLI10;Data Source={0};Persist Security Info=True;User Id=climber;Password=climb1bike2;Initial Catalog=BicycleClimbs",
                                databaseServerName);
